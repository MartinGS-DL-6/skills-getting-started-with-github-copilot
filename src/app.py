...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practices and weekend matches",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "laura@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Lap training and stroke improvement for all levels",
    ...
    "Math Olympiad": {
        ...
        "max_participants": 15,
        "participants": ["isabel@mergington.edu", "kevin@mergington.edu"]
    },
    "Science Club": {
        "description": "Experiments, projects, and science fair preparation",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["oliver@mergington.edu", "rachel@mergington.edu"]
    }
}
